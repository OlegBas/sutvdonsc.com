...
*/
    ...
    static function is_user_singup($value, $param=array())
    {
        global $DB;
    ...
    function regform($location=false,$singup=true,$fuction=false)
    {
		...
		{		   $bata = array
           ...
           $this->db->insert_array($bata, $this->prifix_db."_user");
           ...
           if(is_array($this->uzersConf))
           {
            	 ...
            	 foreach($this->uzersConf as $key => $value)
           		 {                 	 $bata['id_user']   = $idUser;
                     ...
                     $this->db->insert_array($bata, $this->prifix_db."_conf");
           		 }
           }
            if($singup)
            {
	...
	{    	$sql = "SELECT
   			...
   			while($row=$this->db->fetch_array($result))
			{
                   ...
                   $result2 = $this->db->query($sql2);
           		   ...
           		   while($conf=$this->db->fetch_array($result2))
				   {
