...
class lib_object
{
    ...
    function __construct($dbTable, $id, $idrow = 'id')
    {
        ...
        $this->___db = $DB;
        $this->___dbTable = mysql_real_escape_string($dbTable);
        $this->___id      = mysql_real_escape_string($id);
        $this->___idrow   = mysql_real_escape_string($idrow);
    }
    ...
    public function save()
    {
        ...
        $result = $this->___db->update_array($this->___result, $this->___dbTable, $this->where());
