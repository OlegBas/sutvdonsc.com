<?php
try{
    $smpt = new lib_Smpt('mail.nic.ru','sender@sutvdonsk.ru','83XGWf85jQnKH', 2525);
    $smpt->debag = false;
    $smpt->send('biomars@yandex.ru','привет мирsss', 'миру мир! мой мир тир дир бир шир)','sender@sutvdonsk.ru','sutvdonsk.ru');
}catch (Exception $e)
{
    print $e->getMessage();
}
...
$config['smtp_username'] = 'sender@sutvdonsk.ru';  //Смените на адрес своего почтового ящика.
$config['smtp_port'] = '2525'; // Порт работы.
$config['smtp_host'] =  'mail.nic.ru';  //сервер для отправки почты
$config['smtp_password'] = '83XGWf85jQnKH';  //Измените пароль
...
smtpmail('Вася', 'biomars@yandex.ru', 'Тема письма', 'HTML или обычный текст письма');
